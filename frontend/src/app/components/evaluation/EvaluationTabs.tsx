    ...
    <div className="sticky top-24 bg-white border-b border-gray-200 z-40">
      <div className="flex items-stretch">
        ...
        <div className="bg-red-700 px-8 py-5 flex flex-col justify-center min-w-[320px]">
          ...
          <p className="text-sm text-red-100 mt-1.5">{projectAddress}</p>
        </div>
              ...
              {documentTabs.map((docTab) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="ml-1 p-1 hover:bg-gray-200 rounded transition-colors opacity-60 group-hover:opacity-100"
                  >
                    <X className="w-4 h-4" />
                  </button>
